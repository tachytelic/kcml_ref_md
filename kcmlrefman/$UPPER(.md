...
General Form:\
\
1.     alpha_receiver = \$UPPER(alpha_expression)\
\
2.     alpha_receiver = \$UPPER()\
\
3.     \$UPPER() = alpha_expr\
\
\
...
This statement is used in the first form to translate all characters in the specified alpha expression into their uppercase equivalents. The newly translated characters are then stored in the alpha receiver.
...
This function was introduced with KCML 5.0. The user defined tables and the \$UPPER() functions were added for KCML 5.03
