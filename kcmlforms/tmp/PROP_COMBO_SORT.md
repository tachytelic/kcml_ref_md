Sort (combobox control property)
...
If set to *TRUE* KCML will sort the strings alphabetically as they are added to the list box. This property is a design time only property that has no effect if changed under program control.
