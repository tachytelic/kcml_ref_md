ClickIndex (graph control property)
...
In a [Click()](PROP_GRAPH_CLICK.htm) event handler, the **ClickIndex** property contains the index of the data item clicked on (see [Data](PROP_GRAPH_DATA.htm)).

##### Example:


     n = .graphControl.ClickIndex
