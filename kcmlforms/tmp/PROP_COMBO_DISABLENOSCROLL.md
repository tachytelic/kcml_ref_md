DisableNoScroll (combobox control property)
...
If set to *TRUE*, a vertical scroll bar will always be displayed in the drop down area of the combo box. This property is a design time only property that has no effect if changed under program control.
