DBEnabled (gridcell control property)
...
**Determines if the Database associated with the control is enabled**

This applies to data bound grid cells and is identical to the [DBEnabled](PROP_DBEnabled.htm) generic property.
