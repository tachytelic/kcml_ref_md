CursorRow (grid control property)
...
This property is used in conjunction with the [*CursorCol* property to find out the current location of the user cell selection rectangle or cursor following a](PROP_GRID_CCOL.htm) [CursorMove()](PROP_GRID_CURSORMOVE.htm) event. For example: CurrentRow = .GridControl1.CursorRow CurrentCol = .GridControl1.CursorCol
