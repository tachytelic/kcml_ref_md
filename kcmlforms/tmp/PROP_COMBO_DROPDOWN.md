DropDown (combobox control event)
...
This event is called each time the drop down section of a drop down combo box is displayed.

##### Example:


     DEFEVENT Form1.comboControl.DropDown()
