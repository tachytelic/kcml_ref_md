...
*(Default, NoChange, DefaultMode, Alpha, KatakanaHalf, Katakana, Hiragana)*

**Allow the default IME method to be defaulted**

No further information. PROP_GRID_IME

##### Example:


     .editControl.ImeMode = &.Default
