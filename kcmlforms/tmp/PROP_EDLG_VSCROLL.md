VertScroll (edit control property)
...
If set to *TRUE* a vertical scroll bar is placed at the right hand side of the edit control. This property is a design time only property that has no effect if changed under program control.
