...
The Click() event is triggered when the user clicks onto a bar element, pie sector or legend. If the user clicks anywhere else on the graph the [NoItemClick](PROP_GRAPH_NOITEMCLICK.htm) event is triggered instead.
...
##### Example:
    ...
     DEFEVENT Form1.graphControl.Click()
