Case (kcmledit control property)
...
Used to restrict the case entered into the Edit control to either ***All*,** ***Upper*** or ***Lower*** case. This property is a design time only property that has no effect if changed under program control.
